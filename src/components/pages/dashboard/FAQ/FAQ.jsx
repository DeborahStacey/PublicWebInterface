    ...
    return (
      <div className="faq-page" key="faq"> 
        ...
        <Jumbotron> 
          ...
          <font size="3" color="red" face="arial">Q: Why is WellCat useful? </font> <br />
          ...
          <font face="times" size="3" color="red">Q: What can I do on WellCat? </font> <br />
          ...
          <font face="times" size="3" color="red">Q: How public is my information? </font> <br />
